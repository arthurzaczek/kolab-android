...
public class NotificationDialog
{
	...
	public static void showYesNo(Context ctx, int msg,
			DialogInterface.OnClickListener yes,
			DialogInterface.OnClickListener no)
	{
		showYesNo(ctx, ctx.getString(msg), yes, no);
	}

	public static void showYesNo(Context ctx, String msg,
			DialogInterface.OnClickListener yes,
			DialogInterface.OnClickListener no)
	{
		AlertDialog.Builder builder = new AlertDialog.Builder(ctx);
